...
@Component({
  selector: 'app-main',
  templateUrl: './feeding-diary.component.html',
  styleUrls: ['./feeding-diary.component.scss'],
})
export class FeedingDiaryComponent implements OnInit, OnDestroy, AfterViewInit {
